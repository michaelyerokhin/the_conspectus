...
/**
 * Mock profile data matching PublicProfileSchema structure
 * Note: In production, this will come from Supabase
 */
export const mockPeopleData: PublicProfile[] = [
  {
    id: "00000000-0000-0000-0000-000000000001",
    first_name: "Sam",
    last_name: "Altman",
    establishment_alignment: 8,
    governance_style: 7,
    market_policy: 5,
    environmental_approach: 4,
    social_policy: 6,
    individualism: 8,
    innovation_approach: 9,
    international_outlook: 7,
  },
  {
    id: "00000000-0000-0000-0000-000000000002",
    first_name: "Jensen",
    last_name: "Huang",
    establishment_alignment: 6,
    governance_style: 5,
    market_policy: 7,
    environmental_approach: 3,
    social_policy: 8,
    individualism: 7,
    innovation_approach: 4,
    international_outlook: 7,
  },
  {
    ...
    first_name: "Elon",
    last_name: "Musk",
    establishment_alignment: 4,
    governance_style: 6,
    market_policy: 2,
    environmental_approach: 9,
    social_policy: 3,
    individualism: 8,
    innovation_approach: 6,
    international_outlook: 4,
  },
  {
    id: "00000000-0000-0000-0000-000000000004",
    first_name: "Sundar",
    last_name: "Pichai",
    establishment_alignment: 7,
    governance_style: 5,
    market_policy: 8,
    environmental_approach: 4,
    social_policy: 6,
    individualism: 7,
    innovation_approach: 3,
    international_outlook: 7,
  },
  {
